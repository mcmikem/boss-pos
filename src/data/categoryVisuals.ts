...
import { Smartphone, Cookie, CupSoda, Pen, Printer, Scissors, Clapperboard, Trophy, Palette, Package } from 'lucide-react';
...
export const CATEGORY_VISUALS: Record<string, CategoryVisual> = {
  ...
  'Eatery': { gradient: 'from-amber-800/80 via-orange-700/50 to-stone-900/90', icon: Cookie, glow: 'rgba(245,158,11,0.15)' },
  'Drinks': { gradient: 'from-sky-800/80 via-cyan-700/50 to-slate-900/90', icon: CupSoda, glow: 'rgba(56,189,248,0.15)' },
  ...
  'Library': { gradient: 'from-stone-800/80 via-zinc-700/50 to-slate-900/90', icon: Clapperboard, glow: 'rgba(120,113,108,0.15)' },
